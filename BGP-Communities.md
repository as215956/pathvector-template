...
| ROUTER_LOCATION_ID  | /etc/bird/define/general.conf | The location ID of the router           |
| ROUTER_ID           | /etc/bird/define/general.conf | ID of the router itself                 |
| SESSION_ASN         | auto generated by function    | ASN of the peer                         |
| IX_ASN              | auto generated by function    | ASN of the peer                         |

### ROUTER_REGION_CODE

Region code for the location of the router.
...
Country code for the location of the router, can be UN/LOcode
country id or country code phone number
...
Location ID for the router, you can decide this number schema by
yourself, personally I just increment this number for every new
Point of Press location.

### ROUTER_ID

Router ID, you can decide this number schema by yourself depending
on how many routers you have in a location. I just use XX since I'm
not going to have more then 100 routers in one location and prefix
the location ID.
...
| Code | Description            |
| ---- | ---------------------- |
| 0101 | Location 1, Router 1   |
| 0601 | Location 6, Router 1   |
| 1103 | Location 11, Router 3  |
| 9999 | Location 99, Router 99 |
